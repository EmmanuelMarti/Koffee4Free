...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 03 Décembre 2015 à 22:44
...
(1, 'Vous voyez une personne agée traversée que faites-vous ?', '{"1":{"text":"str","img":"path\\/to\\/img"},"2":{"text":"str","img":"path\\/to\\/img"},"3":{"text":"str","img":"path\\/to\\/img"}}', 0, 'Quizz');
